function miss = result_eval(conf,aboxes,model_stage,imdb,roidb)
%% Evaluation
% init log
cache_dir = fullfile(pwd, 'output', conf.exp_name, 'fast_rcnn_cachedir', model_stage.cache_name, imdb.name);
