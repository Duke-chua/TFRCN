function save_model_path = proposal_train_kaist_lwir(conf, imdb_train, roidb_train, varargin)
% save_model_path = proposal_train_kaist_lwir(conf, imdb_train, roidb_train, varargin)
% --------------------------------------------------------
% RPN_BF
