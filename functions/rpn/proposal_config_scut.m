function conf = proposal_config_scut(varargin)
% conf = proposal_config_scut(varargin)
% --------------------------------------------------------
% RPN_BF
...
%                                         true,           @islogical);
   ...
   ip.addParamValue('drop_fg_boxes_runoff_image', ...
    ...
    ip.addParamValue('scales',          576,            @ismatrix);
    % Max pixel size of a scaled input image
    ip.addParamValue('max_size',        720,           @isscalar);
    ...
    %% testing
    ip.addParamValue('test_scales',     576,            @isscalar);
    ip.addParamValue('test_max_size',   720,            @isscalar);
