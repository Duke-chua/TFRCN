function detector = do_trian_bf( varargin )
...
%   save([opts.name 'Detector.mat'],'detector'); % for test
  ...
  if stage < numel(opts.nWeak)-1
      ...
      BF.do_test_bf('name',[opts.name '_stage' num2str(stage) '_'],'roidb_test', opts.roidb_test, 'imdb_test', opts.imdb_test, ...
          'gtDir',[dataDir 'test25/annotations'],'pLoad',[pLoad, 'hRng',[50 inf],...
          'vType',{{'none','partial'}},'xRng',[10 700],'yRng',[10 570]],...
