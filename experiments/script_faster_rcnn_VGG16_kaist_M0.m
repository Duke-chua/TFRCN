function script_faster_rcnn_VGG16_kaist_M0()
...
exp_name = 'faster_rcnn_kaist_VGG16_0';
...
% test
conf_fast_rcnn.method_name  = 'stage1-fast-rcnn-0-1';
...
% proposal
conf_proposal.method_name   = 'stage2-rpn-0-1';
...
% test
model.stage2_rpn.nms        = model.nms.test; %M0
...
% proposal
model.stage2_rpn.nms        = model.nms.test_propsal; %M0
dataset.roidb_test          = Faster_RCNN_Train.do_generate_proposal_pd(conf_proposal, model.stage2_rpn, dataset.imdb_test, dataset.roidb_test);
% test
conf_fast_rcnn.method_name  = 'fast-rcnn-0-1';
