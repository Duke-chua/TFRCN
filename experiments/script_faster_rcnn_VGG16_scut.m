function script_faster_rcnn_VGG16_scut()
...
cache_base_fast_rcnn        = 'vgg16_conv53';
% train/test data
dataset                     = [];
use_flipped                 = false;
...
dataset.roidb_test          = Faster_RCNN_Train.do_generate_proposal_pd(conf_proposal, model.stage2_rpn, dataset.imdb_test, dataset.roidb_test);
% test
conf_fast_rcnn.method_name  = 'stage2-fast-rcnn';
model.stage2_fast_rcnn.nms  = model.nms.test;
