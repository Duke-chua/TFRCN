...
exp_name = 'faster_rcnn_kaist_VGG16_3-1';
...
% proposal
conf_proposal.method_name   = 'stage1-rpn-3-1';
...
% test
conf_fast_rcnn.method_name  = 'stage1-fast-rcnn-3-1';
...
% proposal
conf_proposal.method_name   = 'stage2-rpn-3-1';
...
dataset.roidb_test          = Faster_RCNN_Train.do_generate_proposal_pd(conf_proposal, model.stage2_rpn, dataset.imdb_test, dataset.roidb_test);
% test
conf_fast_rcnn.method_name  = 'fast-rcnn-3-1';
