function script_faster_rcnn_VGG16_kaist_M2()
...
exp_name = 'faster_rcnn_kaist_VGG16_2';
% do validation, or not 
opts.do_val                 = true; 
% model
model                       = Model.VGG16_for_Faster_RCNN_M0; %M2
% cache base
...
% proposal
conf_proposal.method_name   = 'stage1-rpn-2';
...
% test
model.stage1_rpn.nms        = model.nms.test_propsal; %M2
...
% test
conf_fast_rcnn.method_name  = 'stage1-fast-rcnn-2';
...
% proposal
conf_proposal.method_name   = 'stage2-rpn-2';
...
% test
model.stage2_rpn.nms        = model.nms.test_propsal;  %M2
...
dataset.roidb_test          = Faster_RCNN_Train.do_generate_proposal_pd(conf_proposal, model.stage2_rpn, dataset.imdb_test, dataset.roidb_test);
% test
conf_fast_rcnn.method_name  = 'fast-rcnn-2';
