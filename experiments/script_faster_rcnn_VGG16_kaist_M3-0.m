function script_faster_rcnn_VGG16_kaist_M3()
...
exp_name = 'faster_rcnn_kaist_VGG16_3';
% do validation, or not 
opts.do_val                 = true; 
% model
model                       = Model.VGG16_for_Faster_RCNN_M0; %M0
% cache base
...
% proposal
conf_proposal.method_name   = 'stage1-rpn-3';
...
% test
conf_fast_rcnn.method_name  = 'stage1-fast-rcnn-3';
...
% proposal
conf_proposal.method_name   = 'stage2-rpn-3';
...
dataset.roidb_test          = Faster_RCNN_Train.do_generate_proposal_pd(conf_proposal, model.stage2_rpn, dataset.imdb_test, dataset.roidb_test);
% test
conf_fast_rcnn.method_name  = 'fast-rcnn-3';
...
function [anchors, output_width_map, output_height_map] = proposal_prepare_anchors(conf, cache_name, test_net_def_file)
    ...
    anchors                = proposal_generate_anchors_pd(cache_name, ...
                                    'scales',  [2.8125 3.2500 3.5625 3.9375 4.4375 5.0000 5.7500 6.8125 8.7500],... %M3
                                    'ratios',  [1 / 0.44], ...   %M3
