function model_stage = do_proposal_train_scut(conf, dataset, model_stage, do_val)
    if ~do_val
        dataset.imdb_test = struct();
        dataset.roidb_test = struct();
    end

    model_stage.output_model_file = proposal_train_scut(conf, dataset.imdb_train, dataset.roidb_train, ...
                                    'do_val',           do_val, ...
