function model_stage = do_fast_rcnn_train_pd(conf, dataset, model_stage, do_val)
    if ~do_val
        dataset.imdb_test = struct();
        dataset.roidb_test = struct();
    end

    model_stage.output_model_file = fast_rcnn_train_pd(conf, dataset.imdb_train, dataset.roidb_train, ...
                                    'do_val',           do_val, ...
