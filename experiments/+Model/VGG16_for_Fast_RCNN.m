function model = VGG16_for_Fast_RCNN(exp_name,model)
...
model.stage1_fast_rcnn.solver_def_file          = fullfile(pwd, 'models', exp_name, 'fast_rcnn_prototxts', 'vgg_16layers_conv3_1', 'solver_30k40k.prototxt');
model.stage1_fast_rcnn.test_net_def_file        = fullfile(pwd, 'models', exp_name, 'fast_rcnn_prototxts', 'vgg_16layers_conv3_1', 'test.prototxt');
