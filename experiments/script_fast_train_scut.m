function script_fast_train_scut()
...
cache_base_fast_rcnn        = 'vgg16_conv53_hole';
% train/test data
dataset                     = [];
use_flipped                 = false;
...
% test
conf_proposal.method_name   = 'RPN-skip02-anchor-overall';
...
dataset.roidb_test          = Faster_RCNN_Train.do_generate_proposal_pd(conf_proposal, model.stage1_rpn, dataset.imdb_test, dataset.roidb_test);
% test
conf_fast_rcnn.method_name  = 'fast-conv53-hole-overall-skip02';
