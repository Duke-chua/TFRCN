function roidb = roidb_from_kaist_visible(imdb, flip)
% roidb = roidb_from_kaist_visible(imdb, flip)
...
if flip
    cache_file = ['./imdb/cache/roidb_kaist_visible_' imdb.name '_flip'];
else
    cache_file = ['./imdb/cache/roidb_kaist_visible_' imdb.name];
end
