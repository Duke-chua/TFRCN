function roidb = roidb_from_kaist_lwir(imdb, flip)
% roidb = roidb_from_kaist_lwir(imdb, flip)
...
anno_path = ['./datasets/kaist_lwir/' roidb.name '/annotations'];
...
if flip
    cache_file = ['./imdb/cache/roidb_kaist_lwir_' imdb.name '_flip'];
else
    cache_file = ['./imdb/cache/roidb_kaist_lwir_' imdb.name];
end
